...
(async () => {
  ...
  await fs.writeFile("actinic-keratosis-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("actinic-keratosis-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
